...
struct DosEnvec
{
    ...
    ULONG de_SecOrg;         /* Unused. Must be 0 for now. */
    ...
    ULONG de_BufMemType;     /* Type of memory for buffers. See <exec/memory.h>.
                            */
    ...
    ULONG de_DosType;        /* Type of disk. See <dos/dos.h> for definitions.
                            */
...
{
    ULONG  fssm_Unit;    /* Unit number of device used. Can also be an STRPTR */
